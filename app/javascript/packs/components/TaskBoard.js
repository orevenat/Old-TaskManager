...
export default class TasksBoard extends React.Component {
  ...
  getBoard() {
    return {
      lanes: [
        ...
        this.generateLane('ready_for_realese', 'Ready for realese'),
        this.generateLane('realesed', 'Realesed'),
  ...
  loadLines() {
    ...
    this.loadLine('ready_for_realese');
    this.loadLine('realesed');
